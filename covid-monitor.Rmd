...
days=1:n
ylims=c(1,1000)
plot(date.R,UK.daily,ylim=ylims,type="p", log="y",xlab="Date", ylab = "Daily number of deaths", pch=19,cex=0.9,bty="n",axes=F, col=cols[4])
axis.Date(1,at=date.R,cex=0.7)
axis(2,cex=0.7,las=2)
points(date.R,It.daily, pch=19, col=cols[1]) 
text(date.R[6],20,"Italy",col=cols[1])
text(date.R[20],20,"UK",col=cols[4])
